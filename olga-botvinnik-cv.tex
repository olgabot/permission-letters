...
\cvline{\texttt{anchor}}{Categorizes alternative splicing data into ``modes''---bimodal, unimodal, or uniform. \url{http://github.com/YeoLab/anchor} (1 star on GitHub)}
...
\cvline{\small\texttt{prettyplotlib}}{Painlessly create beautiful \texttt{matplotlib} plots. \url{http://github.com/olgabot/prettyplotlib} (1,159 stars on GitHub)}

\cvline{\texttt{seaborn}}{Contributor, wrote clustered heatmap classes and function. \url{http://github.com/mwaskom/seaborn} 3,602 stars on GitHub}
